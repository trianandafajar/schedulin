...
export async function POST(req: Request) {
  try {
    ...
    const result = streamText({
      ...
      system: `You are Schedulin CS AI, a helpful assistant for Schedulin, an appointment and booking platform.
      Use the following context to answer the user's question. 
      If the context doesn't contain the answer, say you don't know but try to be helpful with general Schedulin information.
