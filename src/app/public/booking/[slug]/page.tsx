...
export default function PublicBookingPage({ params }: PageProps) {
  ...
  // Force light mode strictly on public booking page
  useEffect(() => {
    ...
    return (
      <div className="min-h-screen bg-brand-50 p-6 font-sans flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="animate-spin w-12 h-12 text-brand-500 mx-auto mb-4" />
    ...
    return (
      <div className="min-h-screen bg-brand-50 p-6 font-sans flex items-center justify-center">
        <div className="text-center bg-white rounded-3xl shadow-xl border border-gray-100 p-10 max-w-md">
          ...
          <div className="bg-brand-50/50 border border-brand-100 rounded-2xl p-5 text-left mb-6 space-y-2">
            <p className="text-sm font-semibold text-brand-600">{selectedService?.name}</p>
  ...
  return (
    <div className="min-h-screen bg-brand-50 p-6 font-sans pt-12">
      <div className="max-w-6xl mx-auto space-y-10">

        <div className="flex flex-col lg:flex-row gap-10">

          <div className="w-full lg:w-96 order-1 lg:order-1">
            <div className="bg-white border border-gray-100 rounded-2xl shadow-xl p-6 flex flex-col gap-6 sticky top-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {services.length > 0 ? services.map((service) => (
                    <button
                      ...
                      className="p-5 border-2 border-gray-100 rounded-2xl text-left hover:border-brand-500 hover:bg-brand-50 transition-all space-y-2 group"
                    >
                      <div className="font-semibold text-lg text-gray-800 group-hover:text-brand-900">{service.name}</div>
                      <div className="text-sm text-gray-500">
                        Duration: {service.duration_minutes} minutes
                      </div>
                      <div className="text-brand-600 font-bold text-lg pt-1">
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`p-3 border font-semibold rounded-xl text-xs transition
                                                    ${selectedTime === time ? "bg-brand-500 text-white border-brand-500" : "text-gray-800"}
                                                    ${disabled ? "bg-gray-200 text-gray-300 cursor-not-allowed line-through" : "border-gray-100 hover:bg-brand-100 hover:border-brand-100"}
                                                  `}
                                            >
                                                {time}
                                            </button>
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleConfirmBooking(); }} className="p-8 space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pl-10 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:ring-brand-500/10"
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="dark:bg-dark-900 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:ring-brand-500/10"
