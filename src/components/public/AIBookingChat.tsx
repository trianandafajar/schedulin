    ...
    return (
      <div className="flex items-center gap-2 w-full mt-1 mb-1">
        ...
        <button 
          ...
          className="rounded-xl bg-brand-500 px-3 py-2.5 text-white disabled:bg-gray-300 transition-all flex items-center justify-center shrink-0"
        >
  ...
  return (
    <button
      ...
      className={`w-full text-left rounded-xl border border-brand-500 bg-white px-4 py-2.5 text-sm text-brand-500 font-medium transition-all
        ${disabled ? "opacity-50 cursor-not-allowed" : "hover:bg-brand-500 hover:border-brand-500"}`}
    >
      {option.label}
    </button>
  );
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
                ...
                <div className="flex flex-col gap-2 w-full">
                  {QUICK_PROMPTS.map((p) => (
                    <button
                      ...
                      className="rounded-2xl border border-brand-500 bg-brand-500 px-4 py-3 text-sm text-white font-bold transition-all text-center"
                    >
      ...
      <button
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-brand-500 text-white transition-all hover:scale-110 active:scale-95"
